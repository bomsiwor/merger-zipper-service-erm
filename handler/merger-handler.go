...
func NewMergeHandler() *mergerHandler {
	return &mergerHandler{}
}

func (h *mergerHandler) MergerByPathHandler(w http.ResponseWriter, r *http.Request) {
	...
	result, err := utils.CombinePdf(&requestData.OutputName, requestData.Source, workDir, requestData.OutputDir)
	if err != nil {
